  ...
  <div class="sidebar">
    ...
    <nav class="mt-2">
      <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        ...
        <li class="nav-item has-treeview {{ active_menu('subscriptions')[0] }} ">
          <a href="#" class="nav-link ">
          ...
          <ul class="nav nav-treeview" style=" {{ active_menu('subscriptions')[1] }} ">

            <li class="nav-item">
              <a href="{{aurl('subscriptions')}}" class="nav-link">
            ...
            <li class="nav-item">
              <a href="{{aurl('subscriptions/create')}}" class="nav-link">
                <i class="fa fa-plus nav-icon"></i>
                <p>{{ trans('admin.add') }}</p>
              </a>
            </li>
